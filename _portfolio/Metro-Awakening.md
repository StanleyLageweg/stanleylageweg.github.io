...
{% responsive_video "/assets/portfolio/impact/firearms/kalashnikov-reload.mp4" autoplay="autoplay" loading="lazy" %}
...
{% responsive_video "/assets/portfolio/impact/firearms/kalashnikov-reload-filled-chamber.mp4" autoplay="autoplay" loading="lazy" %}
...
<div style="container-type: inline-size; margin-top: 1em">
  <div class="video-grid__responsive">
    <div style="width: 100%; text-align: center;">
      {% responsive_video "/assets/portfolio/impact/firearms/kalashnikov-reload-knock-out-before.mp4" autoplay="autoplay" loading="lazy" %}
      <em>Before</em>
    </div>
    <div style="width: 100%; text-align: center;">
      {% responsive_video "/assets/portfolio/impact/firearms/kalashnikov-reload-knock-out-after.mp4" autoplay="autoplay" loading="lazy" %}
      <em>After</em>
    </div>
  </div>
</div>
...
{% responsive_video "/assets/portfolio/impact/firearms/tokarev-slide.mp4" autoplay="autoplay" loading="lazy" %}
...
{% responsive_video "/assets/portfolio/impact/firearms/kalashnikov-10x.mp4" autoplay="autoplay" loading="lazy" %}
...
{% responsive_video "/assets/portfolio/impact/firearms/helsing-reload.mp4" autoplay="autoplay" loading="lazy" %}
...
<div style="container-type: inline-size">
  <div class="video-grid__responsive">
    {% responsive_video "/assets/portfolio/impact/hand-animations/hand-animations-game.mp4" autoplay="autoplay" loading="lazy" crop="1600:900:240:130" %}
    {% responsive_video "/assets/portfolio/impact/hand-animations/hand-animations-controller.mp4" autoplay="autoplay" loading="lazy" %}
  </div>
</div>
...
<div style="container-type: inline-size">
  <div class="video-grid__responsive">
    {% responsive_video "/assets/portfolio/impact/hand-movement/hand-movement.mp4" autoplay="autoplay" loading="lazy" start_time="868ms" duration="33006ms" crop="1920:992:0:88" %}
    {% responsive_video "/assets/portfolio/impact/hand-movement/hand-movement-vislog.mp4" autoplay="autoplay" loading="lazy" start_time="1307ms" duration="43527ms" speed="38774/29402" crop="1920:992:0:20" %}
  </div>
</div>
...
{% responsive_video "/assets/portfolio/impact/hand-interaction/socket.mp4" autoplay="autoplay" loading="lazy" %}

Additionally, the rotating poses can be configured to rotate while the player is holding the object.

{% responsive_video "/assets/portfolio/impact/hand-interaction/valve.mp4" autoplay="autoplay" loading="lazy" %}
...
<div style="container-type: inline-size">
  <div class="video-grid__responsive">
    {% responsive_video "/assets/portfolio/impact/hand-interaction/planks.mp4" autoplay="autoplay" loading="lazy" %}
    {% responsive_video "/assets/portfolio/impact/hand-interaction/supply-boxes.mp4" autoplay="autoplay" loading="lazy" %}
    {% responsive_video "/assets/portfolio/impact/hand-interaction/levers.mp4" autoplay="autoplay" loading="lazy" %}
    {% responsive_video "/assets/portfolio/impact/hand-interaction/valve-door.mp4" autoplay="autoplay" loading="lazy" %}
    {% responsive_video "/assets/portfolio/impact/hand-interaction/doors.mp4" autoplay="autoplay" loading="lazy" %}
    {% responsive_video "/assets/portfolio/impact/hand-interaction/pry-door.mp4" autoplay="autoplay" loading="lazy" %}
  </div>
</div>
...
<div style="container-type: inline-size">
  <div class="video-grid__responsive">
    <div style="width: 100%; text-align: center;">
      {% responsive_video "/assets/portfolio/impact/locomotion/stick.mp4" autoplay="autoplay" loading="lazy" %}
      <em>Stick Locomotion</em>
    </div>
    <div style="width: 100%; text-align: center;">
      {% responsive_video "/assets/portfolio/impact/locomotion/teleport.mp4" autoplay="autoplay" loading="lazy" %}
...
<div style="container-type: inline-size">
  <div class="video-grid__responsive">
    <div style="width: 100%; text-align: center;">
      {% responsive_video "/assets/portfolio/impact/foot-ik/before.mp4" autoplay="autoplay" loading="lazy" %}
      <em>Before</em>
    </div>
    <div style="width: 100%; text-align: center;">
      {% responsive_video "/assets/portfolio/impact/foot-ik/after-debug.mp4" autoplay="autoplay" loading="lazy" %}
      <em>After</em>
    </div>
  </div>
</div>
...
{% responsive_video "/assets/portfolio/impact/foot-ik/foot-ik.mp4" autoplay="autoplay" loading="lazy" speed="2" crop="1582:1256:486:108" %}
