...
<div style="container-type: inline-size">
    <div class="video-grid__responsive">
        {% responsive_video "/assets/portfolio/unbound/platforming.mp4" autoplay="autoplay" loop="loop" loading="lazy" %}
        {% responsive_video "/assets/portfolio/unbound/climbing.mp4" autoplay="autoplay" loop="loop" loading="lazy" %}
        {% responsive_video "/assets/portfolio/unbound/sliding.mp4" autoplay="autoplay" loop="loop" loading="lazy" %}
        {% responsive_video "/assets/portfolio/unbound/swimming.mp4" autoplay="autoplay" loop="loop" loading="lazy" %}
    </div>
</div>
...
{% responsive_video "/assets/portfolio/unbound/camera-movement/pause-menu.mp4" autoplay="autoplay" loop="loop" loading="lazy" %}
...
<div style="container-type: inline-size">
    <div class="video-grid__responsive">
        <div style="width: 100%; text-align: center;">
            {% responsive_video "/assets/portfolio/unbound/camera-smoothing/disabled.mp4" autoplay="autoplay" loop="loop" loading="lazy" %}
            <em>Before</em>
        </div>
        <div style="width: 100%; text-align: center;">
            {% responsive_video "/assets/portfolio/unbound/camera-smoothing/enabled.mp4" autoplay="autoplay" loop="loop" loading="lazy" %}
            <em>After</em>
        </div>
    </div>
</div>
...
{% responsive_video "/assets/portfolio/unbound/climbing/obstructed-by-level-geometry.mp4" autoplay="autoplay" loop="loop" loading="lazy" %}
...
{% responsive_video "/assets/portfolio/unbound/climbing/interpolation-to-resolve-hand-parity.mp4" autoplay="autoplay" loop="loop" loading="lazy" %}
...
{% responsive_video "/assets/portfolio/unbound/swimming/physical-swimming.mp4" autoplay="autoplay" loop="loop" loading="lazy" %}
...
{% responsive_video "/assets/portfolio/unbound/sliding/horizontal-ground.mp4" autoplay="autoplay" loop="loop" loading="lazy" %}
...
{% responsive_video "/assets/portfolio/unbound/sliding/shallow-slope.mp4" autoplay="autoplay" loop="loop" loading="lazy" %}
...
{% responsive_video "/assets/portfolio/unbound/sliding/steep-slope.mp4" autoplay="autoplay" loop="loop" loading="lazy" %}
