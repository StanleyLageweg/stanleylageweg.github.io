module Jekyll
  module LogCacheKeyLength
    ...
    def run
      image_cache_key = "responsive-images-#{Jekyll::ResponsiveImage.get_cache_key}-#{Jekyll::ResponsiveImage.get_optional_cache_key}-#{"_sha256_" * 8}"
      ...
      video_cache_key = "responsive-videos-#{Jekyll::ResponsiveVideo.get_cache_key}-#{Jekyll::ResponsiveVideo.get_optional_cache_key}-#{"_sha256_" * 8}"
